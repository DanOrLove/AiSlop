...
Скрипт для рассылки:«Добрый день, мне показали ваши работы, очень аккуратно и красиво выполнены. Спасибо, что делаете девушек еще прекраснее) Это прям круто. Дак вот, захотелось предложить улучшить ваш сервис следующим образом.
...
Вот ссылка уже на готовый проект *твоя ссылка* » **Сам промпт для бота:**
